(function (Drupal, $, drupalSettings) {
  ...
  Drupal.behaviors.APIpastellMenuBehavior.get_id_coll = function (id_e) {
    if ((drupalSettings.path.isFront || drupalSettings.path.currentPath === 'lots/docs') && drupalSettings.api_pastell_pleiade.field_pastell_flux_url) {

      var url_pastell = drupalSettings.api_pastell_pleiade.field_pastell_url
      var menu_Pastell = document.getElementById('menuPastell');
      var pastellLDAPGroup = 'pastellenvoienlots';
          ...
          for (var key in response) {
            ...
            switch (itemName) {
              ...
              <div id="collapse' + key + '" class="accordion-collapse collapse' +
                    (localStorage.getItem('extended_menu') === '1' ? ' show' : '') + '" aria-labelledby="headingOne" style="">\
                ...
                <i class="fa fa-plus" aria-hidden="true"></i><span class="hide-menu px-2">Créer un acte</span></a>\
                <a class="sidebar-link waves-effect waves-dark" title="Voir les documents" target="_blank" href="' + url_pastell + '/Document/list?id_e=' + id_e + '&type=' + key + '" aria-expanded="false">\
                <i class="fa fa-ellipsis" aria-hidden="true"></i><span class="hide-menu px-2">Voir les actes</span></a>';
                }
                break;
              ...
              <div id="collapse' + key + '" class="accordion-collapse collapse' +
                    (localStorage.getItem('extended_menu') === '1' ? ' show' : '') + '" aria-labelledby="headingOne" style="">\
                <a class="sidebar-link waves-effect waves-dark" title="Créer un document" target="_blank" href="' + url_pastell + '/Document/new?id_e=' + id_e + '&type=' + key + '" aria-expanded="false">\
                <i class="fa fa-plus" aria-hidden="true"></i><span class="hide-menu px-2">Créer une convocation</span></a>\
                <a class="sidebar-link waves-effect waves-dark" title="Voir les documents" target="_blank" href="' + url_pastell + '/Document/list?id_e=' + id_e + '&type=' + key + '" aria-expanded="false">\
                <i class="fa fa-ellipsis" aria-hidden="true"></i><span class="hide-menu px-2">Voir les convocations</span></a>';
                }
                break;
              ...
              <div id="collapse' + key + '" class="accordion-collapse collapse' +
                    (localStorage.getItem('extended_menu') === '1' ? ' show' : '') + '" aria-labelledby="headingOne" style="">\
                <a class="sidebar-link waves-effect waves-dark" title="Créer un document" target="_blank" href="' + url_pastell + '/Document/new?id_e=' + id_e + '&type=' + key + '" aria-expanded="false">\
                <i class="fa fa-plus" aria-hidden="true"></i><span class="hide-menu px-2">Créer un flux Hélios</span></a>\
                <a class="sidebar-link waves-effect waves-dark" title="Voir les documents" target="_blank" href="' + url_pastell + '/Document/list?id_e=' + id_e + '&type=' + key + '" aria-expanded="false">\
                <i class="fa fa-ellipsis" aria-hidden="true"></i><span class="hide-menu px-2">Voir les flux Hélios</span></a>';
                }
                break;
              case 'Document à faire signer':
                if (userGroupsTempstore.includes('pastell-docs-signer')) {
                  menu_a_remplir += '\
                  <div class="nav-small-cap has-arrow collapsed" data-bs-toggle="collapse" data-bs-target="#collapse' + key + '" aria-expanded="' +
                    (localStorage.getItem('extended_menu') === '1' ? 'true' : 'false') +
                    '" aria-controls="collapse' + key + '">\
                ...
                <div id="collapse' + key + '" class="accordion-collapse collapse' +
                    (localStorage.getItem('extended_menu') === '1' ? ' show' : '') + '" aria-labelledby="headingOne" style="">\
                  <a class="sidebar-link waves-effect waves-dark" title="Créer un document" target="_blank" href="' + url_pastell + '/Document/new?id_e=' + id_e + '&type=' + key + '" aria-expanded="false">\
                  <i class="fa fa-plus" aria-hidden="true"></i><span class="hide-menu px-2">Créer un document</span></a>'
                  if (userGroupsTempstore.includes(pastellLDAPGroup)) {
                    menu_a_remplir += '\
                            <a class="sidebar-link waves-effect waves-dark" title="Envoyer en lots" href="/lots/docs?id_e=' + id_e + '" aria-expanded="false">\
                            <i class="fa fa-layer-group" aria-hidden="true"></i><span class="hide-menu px-2">Envoyer en lots</span></a>'
                  }
                  menu_a_remplir += '\
                  <a class="sidebar-link waves-effect waves-dark" title="Voir les documents" target="_blank" href="' + url_pastell + '/Document/list?id_e=' + id_e + '&type=' + key + '" aria-expanded="false">\
                  <i class="fa fa-ellipsis" aria-hidden="true"></i><span class="hide-menu px-2">Voir les documents</span></a>';
                }
                break;
