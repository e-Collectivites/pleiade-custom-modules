...
!(function (t) {
  ...
  return (
    x.extend(!0, s.defaults, {
      dom: "<'row'<'col-sm-12 col-md-6 d-flex align-items-center justify-content-start mb-2'l><'col-sm-12 col-md-6 mb-2'f>><'row dt-row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
      renderer: "bootstrap",
    }),
