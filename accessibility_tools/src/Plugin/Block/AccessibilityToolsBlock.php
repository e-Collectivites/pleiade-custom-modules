...
<div class="accessibility-panel">
    ...
    <div class="p-3">
        <div class="form-group">
            ...
            <!-- Groupe de boutons -->
            <div class="controls">
                <button type="button" class="btn btn-par" id="increaseFontSize"><i class="fa-solid fa-arrow-up"></i></button>
                <button type="button" class="btn btn-par" id="decreaseFontSize"><i class="fa-solid fa-arrow-down"></i></button>
                <button type="button" class="btn btn-par" id="resetFontSize"><i class="fa-solid fa-rotate-right"></i></button>
            </div>
        </div>
        ...
        <div class="form-group">
           ...
           <!-- Groupe de boutons -->
           <div class="controls">
                <button type="button" class="btn btn-par" id="increaseSpaces"><i class="fa-solid fa-arrow-up"></i></button>
                <button type="button" class="btn btn-par" id="decreaseSpaces"><i class="fa-solid fa-arrow-down"></i></button>
                <button type="button" class="btn btn-par" id="resetSpaces"><i class="fa-solid fa-rotate-right"></i></button>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="checkbox" class="form-check-input persoWidget" data-category="field_ismenuopened" checked>
        </div>
        <div class="form-group">
            <label class="form-check-label">Afficher Watcha :</label>
            <input type="checkbox" class="form-check-input persoWidget" id="persoWatcha" data-category="field_iswatchaactivated" checked>
        </div>
        <div class="form-group">
            <label class="form-check-label">Afficher Activités récentes :</label>
            <input type="checkbox" class="form-check-input persoWidget" id="persoNextCloud" data-category="field_isnextcloudactivated" checked>
        </div>
        <div class="form-group">
            <label class="form-check-label">Afficher GLPI :</label>
            <input type="checkbox" class="form-check-input persoWidget" id="persoGlpi" data-category="field_isglpiactivated" checked>
        </div>
        <div class="form-group">
            <label class="form-check-label">Afficher Post-It :</label>
            <input type="checkbox" class="form-check-input persoWidget" id="persoPostit" data-category="field_ispostitactivated">
         </div>
     </div>
</div>
        <script>
