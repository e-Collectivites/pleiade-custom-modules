                                                                          ...
                                                                          <h4 class="text-dark py-2">\
                                                                                ...
                                                                                if (donnees['notifs'] && donnees['notifs'].results.length > 0) {
                                                                                        ...
                                                                                        for (var i = 0; i < donnees_notif.results.length; i++) {
                                                                                                ...
                                                                                                if (donnees_notif.results[i].output.includes("created Poll")) {
                                                                                                        // Remplace "You were added to Space" par "Vous avez été ajouté à l'espace"
                                                                                                        text = donnees_notif.results[i].output.replace("created Poll", "a créé un sondage : ");
                                                                                                }
                                                                                                if (donnees_notif.results[i].output.includes(" likes Poll")) {
                                                                                                        // Remplace "You were added to Space" par "Vous avez été ajouté à l'espace"
                                                                                                        text = donnees_notif.results[i].output.replace(" likes Poll", " a aimé votre sondage : ");
                                                                                                }
