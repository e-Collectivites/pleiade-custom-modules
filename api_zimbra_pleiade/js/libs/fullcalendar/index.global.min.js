...
var FullCalendar = (function (e) {
  ...
  const o = /(top|left|right|bottom|width|height)$/i;
  function s(e, t) {
    for (let n in t) a(e, n, t[n]);
  }
  function a(e, t, n) {
    null == n
      ? (e.style[t] = "")
      : "number" == typeof n && o.test(t)
      ? (e.style[t] = n + "px")
      : (e.style[t] = n);
  }
  function l(e) {
  ...
  function p(e) {
    return Object.assign({ onClick: e }, g(e));
  }
  function g(e) {
    return {
      tabIndex: 0,
  ...
  function A(e, t, n) {
    let r, i;
    for (r = 0; r < n.length; r += 1) if (((i = y(e, t, n[r])), i)) return i;
    return 0;
  }
  function y(e, t, n) {
    return n.func ? n.func(e, t) : _(e[n.field], t[n.field]) * (n.order || 1);
  }
  function _(e, t) {
    return e || t
      ? null == t
  ...
  const S = ["years", "months", "days", "milliseconds"],
    T = /^(-?)(?:(\d+)\.)?(\d+):(\d\d)(?::(\d\d)(?:\.(\d\d\d))?)?/;
  function k(e, t) {
  ...
  function j(e, t) {
    if (e === t) return !0;
    for (let n in e) if (M.call(e, n) && !(n in t)) return !1;
    for (let n in t) if (M.call(t, n) && e[n] !== t[n]) return !1;
    return !0;
  }
  const z = /^on[A-Z]/;
  function F(e, t) {
    let n = [];
    for (let r in e) M.call(e, r) && (r in t || n.push(r));
    for (let r in t) M.call(t, r) && e[r] !== t[r] && n.push(r);
    return n;
  }
  function L(e, t, n = {}) {
    if (e === t) return !0;
    for (let r in t) if (!(r in e) || !V(e[r], t[r], n[r])) return !1;
  ...
  function X(e, t) {
    return ae(e) === ae(t) ? Math.round(q(e, t)) : null;
  }
  function K(e) {
    return oe([e.getUTCFullYear(), e.getUTCMonth(), e.getUTCDate()]);
  }
  function ee(e, t, n, r) {
    let i = oe([t, 0, 1 + te(t, n, r)]),
      o = K(e),
      s = Math.round(q(i, o));
  ...
  class ye {
    constructor(e) {
      ...
      for (let i in e)
        i in he
          ? ((n[i] = e[i]), (r = Math.max(he[i], r)))
          : ((t[i] = e[i]), i in pe && (r = Math.max(pe[i], r)));
      (this.standardDateProps = t),
        (this.extendedSettings = n),
        (this.severity = r),
        (this.buildFormattingFunc = de(_e));
    }
    format(e, t) {
    ...
    formatRange(e, t, n, r) {
      ...
      let u = _e(
        ...
        p = o.separator || r || n.defaultSeparator || "";
            ...
            return (
              ...
              (function (e, t, n, r, i) {
                ...
                !1 === r.meridiem
                  ? (e = e.replace(ge, "").trim())
                  : "narrow" === r.meridiem
                  ? (e = e.replace(ge, (e, t) => t.toLocaleLowerCase()))
                  : "short" === r.meridiem
                  ? (e = e.replace(ge, (e, t) => t.toLocaleLowerCase() + "m"))
                  : "lowercase" === r.meridiem &&
                    (e = e.replace(ge, (e) => e.toLocaleLowerCase()));
  ...
  function De(e, t, n, r) {
    let i = Ee(e, n.calendarSystem);
    return {
      date: i,
      start: i,
      end: t ? Ee(t, n.calendarSystem) : null,
      timeZone: n.timeZone,
  ...
  class Ce {
    ...
    format(e, t, n) {
      return t.cmdFormatter(this.cmdStr, De(e, null, t, n));
    }
    formatRange(e, t, n, r) {
      return n.cmdFormatter(this.cmdStr, De(e, t, n, r));
    }
  }
  class we {
    constructor(e) {
    ...
    format(e, t, n) {
      return this.func(De(e, null, t, n));
    }
    formatRange(e, t, n, r) {
      return this.func(De(e, t, n, r));
    }
  }
  function Se(e) {
  ...
  const Te = {
      ...
      dayHeaders: Boolean,
      dayHeaderFormat: Se,
      dayHeaderClassNames: Pe,
      dayHeaderContent: Pe,
      dayHeaderDidMount: Pe,
      dayHeaderWillUnmount: Pe,
      dayCellClassNames: Pe,
      dayCellContent: Pe,
      dayCellDidMount: Pe,
      dayCellWillUnmount: Pe,
      initialView: String,
      aspectRatio: Number,
      weekends: Boolean,
      weekNumberCalculation: Pe,
      weekNumbers: Boolean,
      weekNumberClassNames: Pe,
      weekNumberContent: Pe,
      weekNumberDidMount: Pe,
      weekNumberWillUnmount: Pe,
      editable: Boolean,
      viewClassNames: Pe,
      viewDidMount: Pe,
      viewWillUnmount: Pe,
      nowIndicator: Boolean,
      nowIndicatorClassNames: Pe,
      nowIndicatorContent: Pe,
      nowIndicatorDidMount: Pe,
      nowIndicatorWillUnmount: Pe,
      ...
      initialDate: Pe,
      now: Pe,
      eventDataTransform: Pe,
      stickyHeaderDates: Pe,
      stickyFooterScrollbar: Pe,
      viewHeight: Pe,
      defaultAllDay: Boolean,
      eventSourceFailure: Pe,
      eventSourceSuccess: Pe,
      eventDisplay: String,
      ...
      slotLabelFormat: Pe,
      slotLaneClassNames: Pe,
      slotLaneContent: Pe,
      slotLaneDidMount: Pe,
      slotLaneWillUnmount: Pe,
      slotLabelClassNames: Pe,
      slotLabelContent: Pe,
      slotLabelDidMount: Pe,
      slotLabelWillUnmount: Pe,
      dayMaxEvents: Pe,
      dayMaxEventRows: Pe,
      dayMinWidth: Number,
      slotLabelInterval: k,
      ...
      eventHint: String,
      moreLinkClick: Pe,
      moreLinkClassNames: Pe,
      moreLinkContent: Pe,
      moreLinkDidMount: Pe,
      moreLinkWillUnmount: Pe,
      monthStartFormat: Se,
      handleCustomRendering: Pe,
      customRenderingMetaMap: Pe,
  ...
  function Me(e, t) {
    return Array.isArray(e) && Array.isArray(t) ? Q(e, t) : e === t;
  }
  const Ne = {
    type: String,
    component: Pe,
  ...
  function je(e, t, n) {
    ...
    a = B(a, (e) => !s[e.defId].recurringDef);
    for (let e in s) {
      let n = s[e];
      if (n.recurringDef) {
        ...
        let l = ze(n, s, t, r, i.recurringTypes);
        for (let t of l) {
          let n = Ue(e, { start: t, end: r.add(t, s) });
          a[n.instanceId] = n;
        }
      }
    }
  ...
  function Fe(e, t, n, r, i, o) {
    let s = { defs: {}, instances: {} },
      a = it(n);
    for (let l of e) {
      let e = nt(l, t, n, r, a, i, o);
      e && Le(e, s);
    }
    return s;
  }
  function Le(e, t = { defs: {}, instances: {} }) {
    return (
  ...
  const Ke = {
    ...
    et = { start: Pe, end: Pe, date: Pe, allDay: Boolean },
    tt = Object.assign(Object.assign(Object.assign({}, Ke), et), {
      extendedProps: Pe,
    });
  function nt(e, t, n, r, i = it(n), o, s) {
    let { refined: a, extra: l } = rt(e, n, i),
      c = (function (e, t) {
        let n = null;
        e && (n = e.defaultAllDay);
    ...
    let d = (function (e, t, n, r) {
      ...
      s && a && (a = K(a));
      o && ((c = o.marker), s && (c = K(c)), a && c <= a && (c = null));
      c
        ? (l = !0)
        : r ||
    ...
    if (d) {
      let e = ot(a, l, t ? t.sourceId : "", d.allDay, d.hasEnd, n, o),
        r = Ue(e.defId, d.range, d.forcedStartTzo, d.forcedEndTzo);
      return (
  ...
  function rt(e, t, n = it(t)) {
    return He(e, n);
  }
  function it(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Ye), tt),
  ...
  function ot(e, t, n, r, i, o, s) {
    ...
    for (let t of o.pluginHooks.eventDefMemberAdders) Object.assign(a, t(e));
      ...
      (function (e) {
        ...
        t =
          !0 === e
            ...
            ? [e]
            : [];
        return (t = t.map((e) => Object.assign(Object.assign({}, st), e))), t;
      })(e),
      null,
      t
    );
  ...
  function lt(e) {
    let t = Math.floor(q(e.start, e.end)) || 1,
      n = K(e.start);
    return { start: n, end: Z(n, t) };
  }
  function ct(e, t = k(0)) {
    let n = null,
      r = null;
    ...
    return (
      e.start && ((n = K(e.start)), r && r <= n && (r = Z(n, 1))),
      { start: n, end: r }
    );
  }
  function ut(e, t, n, r) {
  ...
  function mt(e, t) {
    let n,
      ...
      i = [],
      { start: o } = t;
    for (e.sort(vt), n = 0; n < e.length; n += 1)
      (r = e[n]),
  ...
  function Dt(e, t, n, r) {
    return {
      dow: e.getUTCDay(),
      isDisabled: Boolean(r && !Et(r.activeRange, e)),
      isOther: Boolean(r && !Et(r.currentRange, e)),
      isToday: Boolean(t && Et(t, e)),
      isPast: Boolean(n ? e < n : !!t && e < t.start),
      isFuture: Boolean(n ? e > n : !!t && e >= t.end),
    };
  }
  function Ct(e, t) {
    let n = ["fc-day", "fc-day-" + G[e.dow]];
    return (
      e.isDisabled
  ...
  const wt = Se({ year: "numeric", month: "long", day: "numeric" }),
    St = Se({ week: "long" });
  function Tt(e, t, n = "day", r = !0) {
    const { dateEnv: i, options: o, calendarApi: s } = e;
    let a = i.format(t, "week" === n ? St : wt);
    if (o.navLinks) {
      let e = i.toDate(t);
      const l = (e) => {
        let r =
      ...
      return Object.assign(
        { title: D(o.navLinkHint, [a, e], a), "data-navlink": "" },
        r ? p(l) : { onClick: l }
      );
    }
    return { "aria-label": a };
  ...
  (zt.prototype.classes = {}),
    (zt.prototype.iconClasses = {}),
    (zt.prototype.baseIconClass = ""),
    (zt.prototype.iconOverridePrefix = "");
  var Ft,
    Lt,
    Vt,
    Wt,
  ...
  function Kt(e, t, n) {
    ...
    if (
      (arguments.length > 2 &&
        (s.children = arguments.length > 3 ? Ft.call(arguments, 2) : n),
      "function" == typeof e && null != e.defaultProps)
    )
      for (o in e.defaultProps) void 0 === s[o] && (s[o] = e.defaultProps[o]);
    return en(e, s, r, i, null);
  }
  function en(e, t, n, r, i) {
    ...
    return null == i && null != Lt.vnode && Lt.vnode(o), o;
  }
  function tn() {
    return { current: null };
  }
  ...
  function on(e, t) {
    if (null == t) return e.__ ? on(e.__, e.__.__k.indexOf(e) + 1) : null;
  ...
  function an(e) {
    ((!e.__d && (e.__d = !0) && Qt.push(e) && !ln.__r++) ||
      Gt !== Lt.debounceRendering) &&
      ((Gt = Lt.debounceRendering) || setTimeout)(ln);
  }
  function ln() {
    for (var e; (ln.__r = Qt.length); )
      (e = Qt.sort(function (e, t) {
  ...
  function cn(e, t, n, r, i, o, s, a, l, c) {
    var u,
      d,
      f,
      h,
        ...
        (h = n.__k[u] =
          null == (h = t[u]) || "boolean" == typeof h
            ...
            : "string" == typeof h ||
              "number" == typeof h ||
              "bigint" == typeof h
            ? en(null, h, null, null, h)
            : Array.isArray(h)
            ? en(nn, { children: h }, null, null, null)
            : h.__b > 0
            ? en(h.type, h.props, h.key, h.ref ? h.ref : null, h.__v)
            : h)
      ) {
        if (
          ((h.__ = n),
          (h.__b = n.__b + 1),
          null === (f = v[u]) || (f && h.key == f.key && h.type === f.type))
        )
          v[u] = void 0;
        else
          for (d = 0; d < b; d++) {
            if ((f = v[d]) && h.key == f.key && h.type === f.type) {
              v[d] = void 0;
              break;
            }
            f = null;
          }
        vn(e, h, (f = f || Yt), i, o, s, a, l, c),
          (p = h.__e),
          (d = h.ref) &&
            f.ref != d &&
            (m || (m = []),
            f.ref && m.push(f.ref, null, h),
            m.push(d, h.__c || p, h)),
          null != p
            ? (null == g && (g = p),
              "function" == typeof h.type && h.__k === f.__k
                ? (h.__d = l = un(h, l, e))
                : (l = fn(e, h, f, v, p, l)),
              "function" == typeof n.type && (n.__d = l))
            : l && f.__e == l && l.parentNode != e && (l = on(f));
      }
    for (n.__e = g, u = b; u--; ) null != v[u] && _n(v[u], v[u]);
    if (m) for (u = 0; u < m.length; u++) yn(m[u], m[++u], m[++u]);
  }
  function un(e, t, n) {
    ...
    e: if ("style" === t)
      if ("string" == typeof n) e.style.cssText = n;
        ...
        if (("string" == typeof r && (e.style.cssText = r = ""), r))
          for (t in r) (n && t in n) || hn(e.style, t, "");
        if (n) for (t in n) (r && n[t] === r[t]) || hn(e.style, t, n[t]);
      }
    else if ("o" === t[0] && "n" === t[1])
      (o = t !== (t = t.replace(/Capture$/, ""))),
        ...
        (e.l[t + o] = n),
        n
          ? r || e.addEventListener(t, o ? mn : gn, o)
          : e.removeEventListener(t, o ? mn : gn, o);
  ...
  function gn(e) {
    this.l[e.type + !1](Lt.event ? Lt.event(e) : e);
  }
  function mn(e) {
    this.l[e.type + !0](Lt.event ? Lt.event(e) : e);
  }
  function vn(e, t, n, r, i, o, s, a, l) {
    var c,
      u,
      d,
      f,
      ...
      e: if ("function" == typeof C) {
        if (
          ...
          null != C.getDerivedStateFromProps &&
            (u.__s == u.state && (u.__s = $t({}, u.__s)),
            $t(u.__s, C.getDerivedStateFromProps(m, u.__s))),
          (f = u.props),
          (h = u.state),
          d)
        )
          ...
          if (
            (null == C.getDerivedStateFromProps &&
              ...
              u.componentWillReceiveProps(m, b),
            (!u.__e &&
              null != u.shouldComponentUpdate &&
              !1 === u.shouldComponentUpdate(m, u.__s, b)) ||
              t.__v === n.__v)
          ) {
            for (
              u.props = m,
          ...
          null != u.componentWillUpdate && u.componentWillUpdate(m, u.__s, b),
        ...
        (u.state = u.__s),
          null != u.getChildContext && (r = $t($t({}, r), u.getChildContext())),
          d ||
            null == u.getSnapshotBeforeUpdate ||
            (p = u.getSnapshotBeforeUpdate(f, h)),
          (D =
            null != c && c.type === nn && null == c.key ? c.props.children : c),
          cn(e, Array.isArray(D) ? D : [D], t, n, r, i, o, s, a, l),
          (u.base = t.__e),
          (t.__h = null),
  ...
  function An(e, t, n, r, i, o, s, a) {
    ...
    if (null === h) d === f || (a && e.data === f) || (e.data = f);
    else {
      if (
        ((o = o && Ft.call(e.childNodes)),
        (c = (d = n.props || Yt).dangerouslySetInnerHTML),
      ...
      if (
        ...
        for (p = o.length; p--; ) null != o[p] && Xt(o[p]);
      a ||
        ("value" in f &&
          void 0 !== (p = f.value) &&
          (p !== e.value ||
            ("progress" === h && !p) ||
            ("option" === h && p !== d.value)) &&
          pn(e, "value", p, d.value, !1),
        "checked" in f &&
          void 0 !== (p = f.checked) &&
          p !== e.checked &&
          pn(e, "checked", p, d.checked, !1));
    }
    return e;
  }
  function yn(e, t, n) {
  ...
  function _n(e, t, n) {
    var r, i;
    if (
      (Lt.unmount && Lt.unmount(e),
      (r = e.ref) && ((r.current && r.current !== e.__e) || yn(r, null, t)),
      null != (r = e.__c))
    ) {
    ...
    if ((r = e.__k))
      for (i = 0; i < r.length; i++)
        r[i] && _n(r[i], t, n || "function" != typeof e.type);
    n || null == e.__e || Xt(e.__e), (e.__ = e.__e = e.__d = void 0);
  }
  function En(e, t, n) {
  ...
  function Dn(e, t, n) {
    ...
    Lt.__ && Lt.__(e, t),
      ...
      vn(
        t,
        (e = ((!r && n) || t).__k = Kt(nn, null, [e])),
        i || Yt,
        Yt,
        void 0 !== t.ownerSVGElement,
        !r && n ? [n] : i ? null : t.firstChild ? Ft.call(t.childNodes) : null,
        o,
  ...
  (Ft = qt.slice),
    ...
    (rn.prototype.setState = function (e, t) {
      ...
      (n =
        ...
        "function" == typeof e && (e = e($t({}, n), this.props)),
        e && $t(n, e),
        null != e && this.__v && (t && this._sb.push(t), an(this));
    }),
    (rn.prototype.forceUpdate = function (e) {
      this.__v && ((this.__e = !0), e && this.__h.push(e), an(this));
    }),
    (rn.prototype.render = nn),
    (Qt = []),
    (ln.__r = 0),
    (Zt = 0);
  var Cn,
  ...
  function Nn() {
    for (var e; (e = Tn.shift()); )
      if (e.__P && e.__H)
        try {
          e.__H.__h.forEach(Pn), e.__H.__h.forEach(Un), (e.__H.__h = []);
        } catch (t) {
  ...
  (Lt.__b = function (e) {
        ...
        (wn === Cn
          ? ((t.__h = []),
            ...
            t.__.forEach(function (e) {
              e.__N && (e.__ = e.__N), (e.__V = kn), (e.__N = e.i = void 0);
            }))
          : (t.__h.forEach(Pn), t.__h.forEach(Un), (t.__h = []))),
        (wn = Cn);
    }),
    (Lt.diffed = function (e) {
      ...
      t &&
        t.__H &&
        (t.__H.__h.length &&
          ((1 !== Tn.push(t) && Sn === Lt.requestAnimationFrame) ||
            ((Sn = Lt.requestAnimationFrame) || Hn)(Nn)),
  ...
  function Pn(e) {
    var t = Cn,
      n = e.__c;
    "function" == typeof n && ((e.__c = void 0), n()), (Cn = t);
  }
  function Un(e) {
    var t = Cn;
    (e.__c = e.__()), (Cn = t);
  ...
  ((zn.prototype = new rn()).isPureReactComponent = !0),
  ...
  (Lt.unmount = function (e) {
    var t = e.__c;
    t && t.__R && t.__R(), t && !0 === e.__h && (e.type = null), Vn && Vn(e);
  }),
    ((Wn.prototype = new rn()).__c = function (e, t) {
      var n = t.__c,
        r = this;
      ...
      var a = function () {
        ...
        l = !0 === t.__h;
      r.__u++ || l || r.setState({ __a: (r.__b = r.__v.__k[0]) }), e.then(s, s);
    }),
    (Wn.prototype.componentWillUnmount = function () {
      this.t = [];
    }),
    (Wn.prototype.render = function (e, t) {
      if (this.__b) {
        if (this.__v.__k) {
      ...
      var i = t.__a && Kt(nn, null, e.fallback);
      return i && (i.__h = null), [Kt(nn, null, t.__a ? null : e.children), i];
    });
    ...
    (t.componentWillUnmount = function () {
      ...
      e.__v
        ? (t.l ||
          ...
          Dn(Kt(Yn, { context: t.context }, e.__v), t.l))
        : t.l && t.componentWillUnmount();
  }
  function Jn(e, t) {
    var n = Kt(qn, { __v: e, i: t });
    return (n.containerInfo = t), n;
  }
  ((Gn.prototype = new rn()).__a = function (e) {
    var t = this,
      n = Qn(t.__v),
      r = t.o.get(e);
    return (
      ...
      function (i) {
        var o = function () {
          t.props.revealOrder ? (r.push(i), Zn(t, e, r)) : i();
        };
        n ? n(o) : o();
      }
    );
  }),
    (Gn.prototype.render = function (e) {
    ...
    (Gn.prototype.componentDidUpdate = Gn.prototype.componentDidMount =
      function () {
        var e = this;
  ...
  (rn.prototype.isReactComponent = {}),
    [
      ...
      Object.defineProperty(rn.prototype, e, {
        configurable: !0,
        get: function () {
  ...
  Lt.event = function (e) {
    return (
      tr && (e = tr(e)),
      (e.persist = nr),
      (e.isPropagationStopped = rr),
      (e.isDefaultPrevented = ir),
      (e.nativeEvent = e)
    );
  };
  var or = {
  ...
  Lt.vnode = function (e) {
    ...
    if ("string" == typeof t) {
      ...
      for (var o in ((r = {}), n)) {
        ...
        (Kn && "children" === o && "noscript" === t) ||
          ...
          ("defaultValue" === o && "value" in n && null == n.value
            ...
            ? (o = "ondblclick")
            : /^onchange(textarea|input)/i.test(o + t) && !er(n.type)
            ? (o = "oninput")
            : /^onfocus$/i.test(o)
            ? (o = "onfocusin")
            : /^onblur$/i.test(o)
      ...
      "select" == t &&
        ...
        (r.value = dn(n.children).forEach(function (e) {
        ...
        (e.props = r),
        n.class != n.className &&
          ((or.enumerable = "className" in n),
          null != n.className && (r.class = n.className),
          Object.defineProperty(r, "className", or));
    }
    (e.$$typeof = $n), sr && sr(e);
  };
  var ar = Lt.__r;
  function lr(e) {
    e();
    let t = Lt.debounceRendering,
      n = [];
    for (
      Lt.debounceRendering = function (e) {
        n.push(e);
      },
        Dn(Kt(cr, {}), document.createElement("div"));
      n.length;

    )
      n.shift()();
    Lt.debounceRendering = t;
  }
  Lt.__r = function (e) {
    ar && ar(e), e.__c;
  };
            ...
            return (
              this.getChildContext ||
                ...
                (this.shouldComponentUpdate = function (e) {
                  this.props.value !== e.value && n.some(an);
                }),
                (this.sub = function (e) {
                  n.push(e);
  ...
  var dr = {
    ...
    cloneElement: function (e, t, n) {
      ...
      return (
        arguments.length > 2 &&
          (s.children = arguments.length > 3 ? Ft.call(arguments, 2) : n),
        en(e.type, s, r || e.key, i || e.ref, null)
      );
    },
    createElement: Kt,
    createRef: tn,
  ...
  const hr = ur({});
  function pr(e, t, n, r, i, o, s, a, l, c, u, d, f) {
    return {
      dateEnv: i,
      options: n,
      pluginHooks: s,
      ...
      createScrollResponder: (e) =>
        new fr(e, c, k(n.scrollTime), n.scrollTimeReset),
  ...
  class gr extends rn {
    shouldComponentUpdate(e, t) {
      return (
        this.debug && console.log(F(e, this.props), F(t, this.state)),
        !L(this.props, e, this.propEquality) ||
          !L(this.state, t, this.stateEquality)
      );
    }
    safeSetState(e) {
      L(
  ...
  (gr.addPropsEquality = function (e) {
    ...
    (gr.contextType = hr),
    (gr.prototype.propEquality = {}),
    (gr.prototype.stateEquality = {});
  class mr extends gr {}
  function vr(e, t) {
  ...
  class yr {
    ...
    build(e, t, n = !0) {
      ...
      return (
        ...
        (a = s),
        c.showNonCurrentDates || (a = bt(a, i.range)),
    ...
    adjustActiveRange(e) {
      ...
      return (
        n &&
          (x(r) < 0 && ((o = K(o)), (o = t.add(o, r))),
          x(i) > 1 && ((s = K(s)), (s = Z(s, -1)), (s = t.add(s, i)))),
        { start: o, end: s }
      );
    }
    buildRangeFromDuration(e, t, n, r) {
      ...
      if (!l) {
        ...
        l = e && O(e) < O(n) ? I(e).unit : r;
      }
      function c() {
        (i = a.startOf(e, l)), (o = a.add(i, n)), (s = { start: i, end: o });
      }
      return (
        x(n) <= 1 &&
          this.isHiddenDay(i) &&
          ((i = this.skipHiddenDays(i, t)), (i = K(i))),
        c(),
    ...
    buildRangeFromDayCount(e, t, n) {
      ...
      o && (a = i.startOf(a, o)),
        ...
        (r = a);
      do {
        (r = Z(r, 1)), this.isHiddenDay(r) || (s += 1);
      } while (s < n);
    ...
    buildDateIncrement(e) {
      ...
      return (
        n || ((t = this.props.dateAlignment) ? k(1, t) : e || k({ days: 1 }))
      );
    }
    refineRange(e) {
      if (e) {
  ...
  function _r(e, t, n) {
    n.emitter.trigger(
      "select",
      Object.assign(Object.assign({}, Er(e, n)), {
  ...
  function Er(e, t) {
    ...
    return (
      Object.assign(
        ...
        ((r = e),
        (i = t.dateEnv),
        Object.assign(Object.assign({}, Gr(r.range, i, r.allDay)), {
          allDay: r.allDay,
        }))
      ),
      n
  ...
  function Dr(e, t, n) {
    ...
    return (
      e
        ? ((o = K(o)), (o = r.add(o, i.defaultAllDayEventDuration)))
  ...
  function Cr(e, t, n, r) {
    ...
    for (let t in e.defs) {
      let s = e.defs[t];
      o.defs[t] = wr(s, i[t], n, r);
    }
    for (let t in e.instances) {
      let s = e.instances[t],
        a = o.defs[s.defId];
      o.instances[t] = Sr(s, a, i[s.defId], n, r);
    }
    return o;
  }
  function wr(e, t, n, r) {
  ...
  function Sr(e, t, n, r, i) {
    ...
    return (
      ...
      a &&
        (l.range = {
          start: l.range.start,
          end: Dr(t.allDay, l.range.start, i),
        }),
      t.allDay && (l.range = { start: K(l.range.start), end: K(l.range.end) }),
      l.range.end < l.range.start &&
        (l.range.end = Dr(t.allDay, l.range.start, i)),
      l
    );
  }
  class Tr {
  ...
  class kr {
    ...
    setProp(e, t) {
      if (e in et)
        ...
        (t = Ke[e](t)), this.mutate({ standardProps: { publicId: t } });
      else if (e in Ke)
        (t = Ke[e](t)), this.mutate({ standardProps: { [e]: t } });
      else if (e in Ye) {
        let n = Ye[e](t);
        (n =
          "color" === e
    ...
    setStart(e, t = {}) {
      let { dateEnv: n } = this._context,
        r = n.createMarker(e);
      if (r && this._instance) {
        let e = ut(this._instance.range.start, r, n, t.granularity);
        t.maintainDuration
    ...
    setEnd(e, t = {}) {
      ...
      if ((null == e || ((n = r.createMarker(e)), n)) && this._instance)
        if (n) {
          let e = ut(this._instance.range.end, n, r, t.granularity);
    ...
    setDates(e, t, n = {}) {
      let r,
        ...
        s = i.createMarker(e);
      var a, l;
      if (s && (null == t || ((r = i.createMarker(t)), r)) && this._instance) {
        let e = this._instance.range;
        !0 === n.allDay && (e = lt(e));
        let t = ut(e.start, s, i, n.granularity);
        if (r) {
          let s = ut(e.end, r, i, n.granularity);
          (l = s),
            (a = t).years === l.years &&
            a.months === l.months &&
            a.days === l.days &&
            a.milliseconds === l.milliseconds
              ...
              : this.mutate({ startDelta: t, endDelta: s, standardProps: o });
        } else
    ...
    get source() {
      ...
      return e
        ? new Tr(this._context, this._context.getCurrentData().eventSources[e])
        : null;
    }
    get start() {
  ...
  function xr(e, t, n) {
    ...
    for (let e in i) {
      let n = i[e],
        a = r[n.defId];
      n.instanceId !== s && o.push(new kr(t, a, n));
    }
    return o;
  }
  function Or(e, t, n, r) {
  ...
  function zr(e, t, n, r, i, o, s) {
    ...
    let h = f.range.start,
      ...
      b = K(Y(p, -1)).valueOf() === K(Y(m, -1)).valueOf();
    return c && !d.allDay && (v || b)
      ? ((g = v ? h : g),
        (m = b ? p : m),
        u && d.hasEnd
          ? a.formatRange(g, m, t, {
              forcedStartTzo: o ? null : f.forcedStartTzo,
              forcedEndTzo: s ? null : f.forcedEndTzo,
            })
          : a.format(g, t, { forcedTzo: o ? null : f.forcedStartTzo }))
      : "";
  }
  function Fr(e) {
    let t = ["fc-event"];
  ...
  const Vr = { start: Pe, end: Pe, allDay: Boolean };
  function Wr(e, t, n) {
    let r = (function (e, t) {
        let { refined: n, extra: r } = He(e, Vr),
        ...
        return Object.assign(
          {
            range: { start: i ? i.marker : null, end: o ? o.marker : null },
            allDay: s,
          },
          r
        );
  ...
  function Qr(e, t, n) {
    return Object.assign(Object.assign({}, Gr(e, t, n)), {
      timeZone: t.timeZone,
    });
  }
  function Gr(e, t, n) {
  ...
  class Xr {
    ...
    diffWholeMonths(e, t) {
      let { calendarSystem: n } = this;
      return ae(e) === ae(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
        ? n.getMarkerMonth(t) -
            n.getMarkerMonth(e) +
    ...
    countDurationsBetween(e, t, n) {
      ...
      return n.years && ((r = this.diffWholeYears(e, t)), null !== r)
        ...
        : n.days && ((r = X(e, t)), null !== r)
        ? r / x(n)
        : (t.valueOf() - e.valueOf()) / O(n);
    }
    startOf(e, t) {
      return "year" === t
        ? this.startOfYear(e)
    ...
    timestampToMarker(e) {
      return "local" === this.timeZone
        ...
        ? oe(this.namedTimeZoneImpl.timestampToArray(e))
        : new Date(e);
    }
    offsetForMarker(e) {
      return "local" === this.timeZone
        ? -re(ie(e)).getTimezoneOffset()
        : "UTC" === this.timeZone
        ? 0
        : this.namedTimeZoneImpl
        ? this.namedTimeZoneImpl.offsetForArray(ie(e))
        : null;
    }
    toDate(e, t) {
      return "local" === this.timeZone
        ...
        ? new Date(
            e.valueOf() -
              1e3 * this.namedTimeZoneImpl.offsetForArray(ie(e)) * 60
          )
  ...
  const oi = {};
  const si = { startTime: k, duration: k, create: Boolean, sourceId: String };
  class ai extends mr {
    constructor() {
      super(...arguments),
    ...
    render() {
      ...
      return ht() || o.push("fc-liquid-hack"), e.children(o, i, r, n);
    }
    componentDidMount() {
  ...
  class di extends mr {
    constructor() {
      super(...arguments),
        ...
        (this.handleEl = (e) => {
          this.props.elRef && vr(this.props.elRef, e);
        });
    }
    render() {
      ...
      let a,
        ...
        u = [];
      if (null != r) {
        const e = "function" == typeof r ? r(o, Kt) : r;
        if (!0 === e) c = !0;
        else {
    ...
    applyQueueudDomNodes() {
      ...
      if (!Q(e, n)) {
        n.forEach(t);
        for (let t of e) r.appendChild(t);
  ...
  di.addPropsEquality({
    ...
    elAttrs: function (e, t) {
      const n = F(e, t);
      for (let e of n) if (!z.test(e)) return !1;
      return !0;
    },
    renderProps: j,
  });
  ...
  class mi extends rn {
    constructor() {
      super(...arguments), (this.InnerContent = vi.bind(void 0, this));
    }
    render() {
      const { props: e } = this,
        t = (function (e, t) {
      ...
      if (e.children) {
        ...
        return e.elTag ? Kt(e.elTag, n, r) : r;
      }
      return Kt(
        di,
  ...
  class bi extends mr {
    render() {
      let { dateEnv: e, options: t, theme: n, viewApi: r } = this.context,
        ...
        a = Dt(o, i.todayRange, null, s),
        l = [ci].concat(Ct(a, n)),
        c = e.format(o, i.dayHeaderFormat),
        u = !a.isDisabled && i.colCnt > 1 ? Tt(this.context, o) : {},
        d = Object.assign(
          Object.assign(
            Object.assign({ date: e.toDate(o), view: r }, i.extraRenderProps),
            { text: c }
          ),
          a
        );
          ...
          elAttrs: Object.assign(
            {
              role: "columnheader",
              colSpan: i.colSpan,
              "data-date": a.isDisabled ? void 0 : ce(o),
            },
            i.extraDataAttrs
          ),
          renderProps: d,
  ...
  class yi extends mr {
    render() {
      ...
      return Kt(
        ...
        {
          elTag: "th",
          elClasses: [ci, ...Ct(s, n), ...(e.extraClassNames || [])],
          elAttrs: Object.assign(
        ...
        (n) =>
          Kt(
            ...
            Kt(n, {
              ...
              elAttrs: { "aria-label": t.format(o, Ai) },
            })
          )
      );
    }
  ...
  class _i extends rn {
    constructor(e, t) {
      super(e, t),
        (this.initialNowDate = Ar(t.options.now, t.dateEnv)),
    ...
    computeTiming() {
      let { props: e, context: t } = this,
        ...
        i = t.dateEnv.add(r, k(1, e.unit)),
        o = i.valueOf() - n.valueOf();
      return (
        (o = Math.min(864e5, o)),
        {
          currentState: { nowDate: r, todayRange: Ei(r) },
          nextState: { nowDate: i, todayRange: Ei(i) },
          waitMs: o,
        }
      );
    }
  ...
  function wi(e, t, n, r, i) {
    switch (t.type) {
      case "RECEIVE_EVENTS":
        return (function (e, t, n, r, i, o) {
          if (t && n === t.latestFetchId) {
            let n = Fe(Si(i, t, o), t, o);
            return r && (n = je(n, r, o)), Qe(ki(e, t.sourceId), n);
          }
          return e;
        })(e, n[t.sourceId], t.fetchId, t.fetchRange, t.rawEvents, i);
      case "RESET_RAW_EVENTS":
        return (function (e, t, n, r) {
          const { defIdMap: i, instanceIdMap: o } = (function (e) {
          ...
          let s = Fe(Si(n, t, r), t, r, !1, i, o);
          t.fetchRange && (s = je(s, t.fetchRange, r));
          return s;
      ...
      case "RESET_EVENTS":
        return t.eventStore;
      case "MERGE_EVENTS":
        return Qe(e, t.eventStore);
      case "PREV":
      case "NEXT":
      case "CHANGE_DATE":
      case "CHANGE_VIEW_TYPE":
        return r ? je(e, r.activeRange, i) : e;
      case "REMOVE_EVENTS":
        return (function (e, t) {
          ...
          for (let e in r) !t.instances[e] && i[r[e].defId] && (o[e] = r[e]);
          return { defs: i, instances: o };
        })(e, t.eventStore);
      case "REMOVE_EVENT_SOURCE":
        return ki(e, t.sourceId);
      case "REMOVE_ALL_EVENT_SOURCES":
        return Ge(e, (e) => !e.sourceId);
  ...
  function Si(e, t, n) {
    ...
    return i && (e = Ti(e, i)), r && (e = Ti(e, r)), e;
  }
  function Ti(e, t) {
    let n;
    if (t) {
  ...
  function Ri(e, t) {
    ...
    return (t.pluginHooks.isPropsValid || xi)(r, t);
  }
  function xi(e, t, n = {}, r) {
    return (
      !(
        ...
        !(function (e, t, n, r) {
          let i = t.getCurrentData(),
            ...
            a = s.defs,
            l = s.instances,
            c = Nr(a, o.isEvent ? e.eventUiBases : { "": i.selectionConfig });
          r && (c = H(c, r));
          let u =
              ((p = e.eventStore),
              ...
              {
                defs: p.defs,
                instances: B(p.instances, (e) => !g[e.instanceId]),
              }),
            d = u.defs,
            f = u.instances,
            h = Nr(d, e.eventUiBases);
          var p, g;
          for (let r in l) {
            let s = l[r],
              p = s.range,
              g = c[s.defId],
              m = a[s.defId];
            if (!Oi(g.constraints, p, u, e.businessHours, t)) return !1;
            let { eventOverlap: v } = t.options,
              b = "function" == typeof v ? v : null;
            for (let e in f) {
              let n = f[e];
              if (yt(p, n.range)) {
                if (!1 === h[n.defId].overlap && o.isEvent) return !1;
                if (!1 === g.overlap) return !1;
                if (b && !b(new kr(t, d[n.defId], n), new kr(t, m, s)))
                  return !1;
              }
            }
            let A = i.eventStore;
            for (let e of g.allows) {
              let i,
                ...
                a = A.defs[m.defId],
                l = A.instances[r];
              if (((i = a ? new kr(t, a, l) : new kr(t, m)), !e(Er(o, t), i)))
                return !1;
            }
          }
          return !0;
      ...
      !(
        ...
        !(function (e, t, n, r) {
          ...
          r && (c = r(c));
          if (!Oi(c.constraints, l, i, e.businessHours, t)) return !1;
          ...
          for (let e in s) {
            ...
            if (yt(l, n.range)) {
              ...
              if (d && !d(new kr(t, o[n.defId], n), null)) return !1;
            }
          }
          for (let e of c.allows) {
            let r = Object.assign(Object.assign({}, n), a);
            if (!e(Er(r, t), null)) return !1;
          }
          return !0;
        })(e, t, n, r)
      )
  ...
  function Oi(e, t, n, r, i) {
    for (let o of e) if (!Ni(Ii(o, t, n, r, i), t)) return !1;
    return !0;
  }
  ...
  function Ni(e, t) {
    for (let n of e) if (_t(n, t)) return !0;
    return !1;
  }
      ...
      fetch(t, r).then((e) => {
        if (e.ok)
          return e.json().then(
            (t) => [t, e],
            () => {
              throw new Bi("Failure parsing JSON", e);
            }
          );
        throw new Bi("Request failed", e);
      })
    );
  }
  class Pi {
  ...
  class ji extends mr {
    constructor() {
      super(...arguments),
        (this.handleEl = (e) => {
          (this.el = e), vr(this.props.elRef, e);
        });
    }
    render() {
      let { props: e } = this,
    ...
    getXScrollbarWidth() {
      return Ui.test(this.props.overflowX)
        ? 0
        : this.el.offsetHeight - this.el.clientHeight;
    }
    getYScrollbarWidth() {
      return Ui.test(this.props.overflowY)
        ? 0
  ...
  class zi {
    ...
    collect(e, t, n) {
      return W(this.currentMap, e, t, n);
    }
    getAll() {
      return U(this.currentMap);
    }
  }
  function Fi(e) {
    let t = i(e, ".fc-scrollgrid-shrink"),
      n = 0;
    for (let e of t) n = Math.max(n, w(e));
    return Math.ceil(n);
  }
  function Li(e, t) {
  ...
  function Vi(e, t) {
    return null != t.maxHeight || Li(e, t);
  }
  function Wi(e, t, n, r) {
    let { expandRows: i } = n;
    ...
    for (let r of e) {
      ...
      for (let i = 0; i < e; i += 1)
        n.push(
          Kt("col", {
            style: {
              width: "shrink" === r.width ? Zi(t) : r.width || "",
              minWidth: r.minWidth || "",
            },
          })
        );
    }
    return Kt("colgroup", {}, ...n);
  }
  function Zi(e) {
    return null == e ? 4 : e;
  }
  ...
  class $i extends mr {
    constructor() {
      super(...arguments),
        (this.processCols = de((e) => e, Qi)),
        (this.renderMicroColGroup = de(Gi)),
        (this.scrollerRefs = new zi()),
        (this.scrollerElRefs = new zi(this._handleScrollerEl.bind(this))),
        (this.state = {
          shrinkWidth: null,
          forceYScrollbars: !1,
    ...
    render() {
      ...
      for (; c < l && "footer" === (a = r[c]).type; )
        f.push(this.renderSection(a, o, !0)), (c += 1);
      let h = !ht();
      const p = { role: "rowgroup" };
      return Kt(
        "table",
        { role: "grid", className: s.join(" "), style: { height: e.height } },
        Boolean(!h && u.length) && Kt("thead", p, ...u),
        Boolean(!h && d.length) && Kt("tbody", p, ...d),
        Boolean(!h && f.length) && Kt("tfoot", p, ...f),
        h && Kt("tbody", p, ...u, ...d, ...f)
      );
    }
    renderSection(e, t, n) {
      return "outerContent" in e
        ? Kt(nn, { key: e.key }, e.outerContent)
        : Kt(
            "tr",
            {
              key: e.key,
              role: "presentation",
              className: Ji(e, this.props.liquid).join(" "),
            },
      ...
      let { props: i } = this,
        ...
        f = Wi(
          ...
          n,
          {
            tableColGroupNode: t,
            tableMinWidth: "",
            clientWidth: i.collapsibleWidth || void 0 === s[d] ? null : s[d],
    ...
    computeShrinkWidth() {
      return Yi(this.props.cols) ? Fi(this.scrollerElRefs.getAll()) : 0;
    }
    computeScrollerDims() {
      let e = Ot(),
  ...
  $i.addStateEquality({ scrollerClientWidths: j, scrollerClientHeights: j });
  class Xi extends mr {
    constructor() {
      super(...arguments),
        (this.handleEl = (e) => {
          (this.el = e), e && Ir(e, this.props.seg);
        });
    }
    render() {
      const { props: e, context: t } = this,
        ...
        { ui: o } = i,
        s = {
          event: new kr(t, i.def, i.instance),
          view: t.viewApi,
          timeText: e.timeText,
          ...
          isStartResizable: !e.disableResizing && Ur(r, t),
    ...
    componentDidUpdate(e) {
      this.el && this.props.seg !== e.seg && Ir(this.el, this.props.seg);
    }
  }
  function Ki(e) {
    return Kt(
      ...
      e.timeText && Kt("div", { className: "fc-event-time" }, e.timeText),
      Kt(
        "div",
        ...
        Kt(
          ...
          e.event.title || Kt(nn, null, " ")
        )
      )
    );
  }
  const eo = Se({ day: "numeric" });
  class to extends mr {
    constructor() {
      super(...arguments), (this.refineRenderProps = fe(ro));
    }
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
      ...
      return Kt(
        mi,
        Object.assign({}, e, {
          elClasses: [...Ct(r, t.theme), ...(e.elClasses || [])],
          elAttrs: Object.assign(
            Object.assign({}, e.elAttrs),
            r.isDisabled ? {} : { "data-date": ce(e.date) }
          ),
          renderProps: r,
  ...
  function no(e) {
    return Boolean(e.dayCellContent || fi("dayCellContent", e));
  }
  function ro(e) {
    let { date: t, dateEnv: n, dateProfile: r, isMonthStart: i } = e,
      o = Dt(t, e.todayRange, null, r),
      s = e.showDayNumber ? n.format(t, i ? e.monthStartFormat : eo) : "";
    return Object.assign(
      Object.assign(Object.assign({ date: n.toDate(t), view: e.viewApi }, o), {
        isMonthStart: i,
        dayNumberText: s,
      }),
      e.extraRenderProps
  ...
  function io(e) {
    let { title: t } = e.event;
    return t && Kt("div", { className: "fc-event-title" }, e.event.title);
  }
  function oo(e) {
    return e.text;
  }
  class so extends mr {
    constructor() {
      super(...arguments),
        (this.state = { titleId: u() }),
        (this.handleRootEl = (e) => {
          (this.rootEl = e), this.props.elRef && vr(this.props.elRef, e);
        }),
    ...
    updateSize() {
      let { isRtl: e } = this.context,
        ...
        o = (function (e) {
          ...
          for (let e of t) {
            let t = dt(n, e.getBoundingClientRect());
            if (!t) return null;
            n = t;
          }
          return n;
      ...
      if (o) {
        let a = i.getBoundingClientRect(),
          l = r ? n(t, ".fc-scrollgrid").getBoundingClientRect().top : o.top,
          c = e ? o.right - a.width : o.left;
        (l = Math.max(l, 10)),
          (c = Math.min(
            c,
  ...
  class ao extends br {
    ...
    render() {
      ...
      return Kt(
        to,
        { elRef: this.handleRootEl, date: r, dateProfile: o, todayRange: i },
        (t, r, i) =>
          Kt(
            so,
            {
            ...
            no(e) &&
              Kt(t, { elTag: "div", elClasses: ["fc-more-popover-misc"] }),
            n.children
          )
      );
    }
      ...
      return e >= 0 && e < n && t >= 0 && t < r
        ? {
            ...
            dateSpan: Object.assign(
              { allDay: !0, range: { start: o.startDate, end: o.endDate } },
              o.extraDateSpan
            ),
            dayEl: i,
  ...
  function co(e) {
    if (e.allDayDate) return { start: e.allDayDate, end: Z(e.allDayDate, 1) };
    let { hiddenSegs: t } = e;
    return { start: uo(t), end: ((n = t), n.reduce(ho).eventRange.range.end) };
    var n;
  }
  function uo(e) {
    return e.reduce(fo).eventRange.range.start;
  }
  function fo(e, t) {
  ...
  const go = [],
    mo = new WeakMap();
  function vo(e) {
    e && "undefined" != typeof document && go.push(bo(document.head, e));
  }
  function bo(e, t) {
  ...
  let Ao;
  "undefined" != typeof document && mo.set(document, !0);
  const yo = {
    id: String,
    defaultAllDay: Boolean,
    url: String,
  ...
  function Eo(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Ye), yo),
  ...
  class Do {
    ...
    formatDate(e, t) {
      let { dateEnv: n } = this.getCurrentData();
      return n.format(n.createMarker(e), Se(t));
    }
    formatRange(e, t, n) {
      let { dateEnv: r } = this.getCurrentData();
      return r.formatRange(r.createMarker(e), r.createMarker(t), Se(n), n);
    }
    formatIso(e, t) {
      let { dateEnv: n } = this.getCurrentData();
    ...
    select(e, t) {
      ...
      let r = this.getCurrentData(),
        i = Wr(n, r.dateEnv, k({ days: 1 }));
      i &&
        (this.dispatch({ type: "SELECT_DATES", selection: i }), _r(i, null, r));
    }
    unselect(e) {
      let t = this.getCurrentData();
      t.dateSelection &&
    ...
    addEvent(e, t) {
      if (e instanceof kr) {
        ...
        return (
          this.getCurrentData().eventStore.defs[t.defId] ||
            (this.dispatch({
              type: "ADD_EVENTS",
              eventStore: Le({ def: t, instance: n }),
            }),
      ...
      if (t instanceof Tr) n = t.internalEventSource;
      else if ("boolean" == typeof t) t && ([n] = U(r.eventSources));
      else if (null != t) {
      ...
      let i = nt(e, n, r, !1);
      if (i) {
        let e = new kr(r, i.def, i.def.recurringDef ? null : i.instance);
        return (
          this.dispatch({ type: "ADD_EVENTS", eventStore: Le(i) }),
          this.triggerEventAdd(e),
          e
        );
      }
    ...
    triggerEventAdd(e) {
      ...
      t.trigger("eventAdd", {
        ...
        relatedEvents: [],
        revert: () => {
          this.dispatch({ type: "REMOVE_EVENTS", eventStore: Rr(e) });
        },
      });
    }
    getEventById(e) {
      ...
      for (let i in n) {
        let o = n[i];
        if (o.publicId === e) {
          if (o.recurringDef) return new kr(t, o, null);
          for (let e in r) {
            let n = r[e];
            if (n.defId === o.defId) return new kr(t, o, n);
          }
        }
      }
      return null;
    ...
    getEventSources() {
      let e = this.getCurrentData(),
        t = e.eventSources,
        n = [];
      for (let r in t) n.push(new Tr(e, t[r]));
      return n;
    }
    getEventSourceById(e) {
      let t = this.getCurrentData(),
        n = t.eventSources;
      e = String(e);
      for (let r in n) if (n[r].publicId === e) return new Tr(t, n[r]);
      return null;
    }
    addEventSource(e) {
      let t = this.getCurrentData();
  ...
  var Co = {
    __proto__: null,
    BASE_OPTION_DEFAULTS: ke,
    identity: Pe,
    refineProps: He,
    createEventInstance: Ue,
    parseEventDef: ot,
    refineEventDef: rt,
    parseBusinessHours: at,
    padStart: E,
    isInt: C,
    parseFieldSpecs: b,
    compareByFieldSpecs: A,
    flexibleCompare: _,
    preventSelection: function (e) {
      e.classList.add("fc-unselectable"), e.addEventListener("selectstart", d);
    },
    allowSelection: function (e) {
      e.classList.remove("fc-unselectable"),
        e.removeEventListener("selectstart", d);
    },
    preventContextMenu: function (e) {
      e.addEventListener("contextmenu", d);
    },
    allowContextMenu: function (e) {
      e.removeEventListener("contextmenu", d);
    },
    ...
    guid: v,
    computeVisibleDayRange: ct,
    isMultiDayRange: function (e) {
      let t = ct(e);
      return q(t.start, t.end) > 1;
    },
    diffDates: ut,
    ...
    memoizeArraylike: function (e, t, n) {
      ...
      return (o) => {
        ...
        for (; l < a; l += 1) i[l] = e.apply(this, o[l]);
        return (r = o), i.splice(a), i;
      };
    },
    memoizeHashlike: function (e, t, n) {
      ...
      return (o) => {
        ...
        for (let a in o)
          if (i[a])
            if (Q(r[a], o[a])) s[a] = i[a];
            else {
              n && n(i[a]);
              let r = e.apply(this, o[a]);
              s[a] = t && t(r, i[a]) ? i[a] : r;
            }
          else s[a] = e.apply(this, o[a]);
        return (r = o), (i = s), s;
      };
    },
    intersectRects: dt,
    pointInsideRect: function (e, t) {
      return (
        e.left >= t.left &&
        e.left < t.right &&
        e.top >= t.top &&
    ...
    elementMatches: r,
    elementClosest: n,
    getEventTargetViaRoot: l,
    getUniqueDomId: u,
    parseClassNames: Ze,
    getCanVGrowWithinCell: ht,
    createEmptyEventStore: We,
    mergeEventStores: Qe,
    getRelevantEvents: Ve,
    eventTupleToStore: Le,
    combineEventUis: $e,
    createEventUi: Je,
    Splitter: class {
      constructor() {
        (this.getKeysForEventDefs = de(this._getKeysForEventDefs)),
          (this.splitDateSelection = de(this._splitDateSpan)),
          (this.splitEventStore = de(this._splitEventStore)),
          (this.splitIndividualUi = de(this._splitIndividualUi)),
          (this.splitEventDrag = de(this._splitInteraction)),
          (this.splitEventResize = de(this._splitInteraction)),
      ...
      splitProps(e) {
        let t = this.getKeyInfo(e),
          ...
          l = {};
        this.eventUiBuilders = H(
          t,
          (e, t) => this.eventUiBuilders[t] || de(gt)
        );
        for (let n in t) {
          let c = t[n],
            u = o[n] || pt,
            d = this.eventUiBuilders[n];
          l[n] = {
            businessHours: c.businessHours || e.businessHours,
            dateSelection: r[n] || null,
            eventStore: u,
            eventUiBases: d(e.eventUiBases[""], c.ui, i[n]),
            eventSelection: u.instances[e.eventSelection]
              ? e.eventSelection
              : "",
            eventDrag: s[n] || null,
      ...
      _getKeysForEventDefs(e) {
        return H(e.defs, (e) => this.getKeysForEventDef(e));
      }
        ...
        if (e) {
          let n = this._splitEventStore(
            ...
            o = (r) => {
              t[r] ||
                (t[r] = {
                  affectedEvents: n[r] || pt,
                  mutatedEvents: i[r] || pt,
                  isEvent: e.isEvent,
                });
            };
          for (let e in n) o(e);
    ...
    buildNavLinkAttrs: Tt,
    preventDefault: d,
    whenTransitionDone: function (e, t) {
      let n = (r) => {
        t(r),
          h.forEach((t) => {
    ...
    computeInnerRect: function (e, t = !1, n) {
      let r = n ? e.getBoundingClientRect() : Nt(e),
        i = Mt(e, t),
        o = {
    ...
    computeEdges: Mt,
    getClippingParents: Bt,
    computeRect: Nt,
    unpromisify: Ht,
    Emitter: Pt,
    rangeContainsMarker: Et,
    intersectRanges: bt,
    rangesEqual: At,
    rangesIntersect: yt,
    rangeContainsRange: _t,
    PositionCache: class {
      constructor(e, t, n, r) {
        this.els = t;
      ...
      similarTo(e) {
        return (
          Ut(this.tops || [], e.tops || []) &&
          Ut(this.bottoms || [], e.bottoms || []) &&
          Ut(this.lefts || [], e.lefts || []) &&
          Ut(this.rights || [], e.rights || [])
        );
      }
    },
    ScrollController: jt,
    ElementScrollController: class extends jt {
      constructor(e) {
        super(), (this.el = e);
      }
      getScrollTop() {
    ...
    WindowScrollController: class extends jt {
      getScrollTop() {
    ...
    startOfDay: K,
    addMs: Y,
    addWeeks: function (e, t) {
      let n = ie(e);
      return (n[2] += 7 * t), oe(n);
    },
    diffWeeks: function (e, t) {
      return q(e, t) / 7;
    },
    diffWholeWeeks: $,
    diffWholeDays: X,
    ...
    asRoughMs: O,
    wholeDivideDurations: function (e, t) {
      let n = null;
      for (let r = 0; r < S.length; r += 1) {
        let i = S[r];
        if (t[i]) {
          let r = e[i] / t[i];
          if (!C(r) || (null !== n && n !== r)) return null;
          n = r;
        } else if (e[i]) return null;
      }
      return n;
    },
    greatestDurationDenominator: I,
    DateEnv: Xr,
    createFormatter: Se,
    formatIsoTimeString: function (e) {
      return (
        E(e.getUTCHours(), 2) +
        ":" +
        E(e.getUTCMinutes(), 2) +
    ...
    SegHierarchy: class {
      ...
      splitEntry(e, t, n) {
        ...
        return (
          ...
          r
            ? (n.push(
                { index: e.index, thickness: e.thickness, span: ti(s, o) },
                ...i
              ),
              r)
            : (n.push(e), 0)
      ...
      insertEntryAt(e, t) {
        ...
        -1 === t.lateral
          ...
          (this.stackCnts[ei(e)] = t.stackCnt);
      }
      findInsertion(e) {
        let {
            levelCoords: t,
        ...
        for (let d = 0; d < o; d += 1) {
          let o = t[d];
          if (!r && o >= s + e.thickness) break;
          let f,
            h = n[d],
            p = ri(h, e.span.start, Kr),
            g = p[0] + p[1];
          for (; (f = h[g]) && f.span.start < e.span.end; ) {
            let e = o + f.thickness;
            e > s && ((s = e), (c = f), (a = d), (l = g)),
              e === s && (u = Math.max(u, i[ei(f)] + 1)),
              (g += 1);
          }
        }
        let d = 0;
        ...
        let f = -1;
        return (
          d < o && t[d] === s && (f = ri(n[d], e.span.end, Kr)[0]),
          {
            touchingLevel: a,
            touchingLateral: l,
            touchingEntry: c,
      ...
      toRects() {
        ...
        for (let i = 0; i < n; i += 1) {
          let n = e[i],
            o = t[i];
          for (let e of n)
            r.push(Object.assign(Object.assign({}, e), { levelCoord: o }));
        }
        return r;
      }
    },
    ...
    getEntrySpanEnd: Kr,
    binarySearch: ri,
    groupIntersectingEntries: function (e) {
      let t = [];
      for (let i of e) {
        let e = [],
          o = { span: i.span, entries: [i] };
        for (let i of t)
          ti(i.span, o.span)
            ? (o = {
    ...
    intersectSpans: ti,
    Interaction: ii,
    interactionSettingsToStore: function (e) {
      return { [e.component.uid]: e };
    },
    interactionSettingsStore: oi,
    ElementDragging: class {
      constructor(e, t) {
        this.emitter = new Pt();
      }
      destroy() {}
    ...
    config: {},
    parseDragMeta: function (e) {
      let { refined: t, extra: n } = He(e, si);
      return {
    ...
    CalendarRoot: ai,
    DayHeader: class extends mr {
      constructor() {
        super(...arguments), (this.createDayHeaderFormatter = de(Di));
      }
      render() {
        let { context: e } = this,
          {
    ...
    computeFallbackHeaderFormat: li,
    TableDateCell: bi,
    TableDowCell: yi,
    DaySeriesModel: class {
      constructor(e, t) {
        let n = e.start,
          { end: r } = e,
          i = [],
          ...
          s = -1;
        for (; n < r; )
          t.isHiddenDay(n) ? i.push(s + 0.5) : ((s += 1), i.push(s), o.push(n)),
            (n = Z(n, 1));
      ...
      getDateDayIndex(e) {
        let { indices: t } = this,
          n = Math.floor(q(this.dates[0], e));
        return n < 0 ? t[0] - 1 : n >= t.length ? t[t.length - 1] + 1 : t[n];
      }
    },
    sliceEventStore: Or,
    hasBgRendering: function (e) {
      return (
    ...
    getElSeg: Mr,
    buildSegTimeText: zr,
    sortEventSegs: function (e, t) {
      let n = e.map(Hr);
      return n.sort((e, n) => A(e, n, t)), n.map((e) => e._seg);
    },
    getSegMeta: function (e, t, n) {
    ...
    Slicer: class {
      constructor() {
        (this.sliceBusinessHours = de(this._sliceBusinessHours)),
          (this.sliceDateSelection = de(this._sliceDateSpan)),
          (this.sliceEventStore = de(this._sliceEventStore)),
      ...
      sliceNowDate(e, t, n, r, ...i) {
        return this._sliceDateSpan(
          { range: { start: e, end: Y(e, 1) }, allDay: !1 },
          t,
          n,
          {},
          r,
      ...
      _sliceBusinessHours(e, t, n, r, ...i) {
        return e
          ? this._sliceEventStore(je(e, Ci(t, Boolean(n)), r), {}, t, n, ...i)
              .bg
          : [];
      }
      _sliceEventStore(e, t, n, r, ...i) {
        if (e) {
          let o = Or(e, t, Ci(n, Boolean(r)), r);
          return {
      ...
      _sliceInteraction(e, t, n, r, ...i) {
        if (!e) return null;
        let o = Or(e.mutatedEvents, t, Ci(n, Boolean(r)), r);
        return {
      ...
      _sliceDateSpan(e, t, n, r, i, ...o) {
        if (!e) return [];
        let s = Ci(t, Boolean(n)),
          a = bt(e.range, s);
        if (a) {
          let t = (function (e, t, n) {
              let r = rt({ editable: !1 }, n),
                i = ot(r.refined, r.extra, "", e.allDay, !0, n);
              return {
                def: i,
                ui: Br(i, t),
                instance: Ue(i.defId, e.range),
                range: e.range,
                isStart: !0,
                isEnd: !0,
              };
      ...
      sliceEventRange(e, t) {
        ...
        this.forceDayIfListItem &&
          ...
          (n = { start: n.start, end: Z(n.start, 1) });
    ...
    applyMutationToEventStore: Cr,
    isPropsValid: xi,
    isInteractionValid: function (e, t, n) {
      let { instances: r } = e.mutatedEvents;
      for (let e in r) if (!_t(t.validRange, r[e].range)) return !1;
      return Ri({ eventDrag: e }, n);
    },
    isDateSelectionValid: function (e, t, n) {
      return !!_t(t.validRange, e.range) && Ri({ dateSelection: e }, n);
    },
    requestJson: Hi,
    BaseComponent: mr,
    setRef: vr,
    ...
    SimpleScrollGrid: $i,
    hasShrinkWidth: Yi,
    renderMicroColGroup: Gi,
    getScrollGridClassNames: qi,
    getSectionClassNames: Ji,
    getSectionHasLiquidHeight: Li,
    getAllowYScrolling: Vi,
    renderChunkContent: Wi,
    computeShrinkWidth: Fi,
    sanitizeShrinkWidth: Zi,
    isColPropsEqual: Qi,
    renderScrollShim: function (e) {
      return Kt("div", {
        className: "fc-scrollgrid-sticky-shim",
        style: { width: e.clientWidth, minWidth: e.tableMinWidth },
      });
    },
    getStickyFooterScrollbar: function (e) {
    ...
    getStickyHeaderDates: function (e) {
    ...
    Scroller: ji,
    getScrollbarWidths: Ot,
    RefMap: zi,
    getIsRtlScrollbarOnLeft: xt,
    NowTimer: _i,
    ScrollResponder: fr,
    StandardEvent: class extends mr {
      render() {
        let { props: e, context: t } = this,
          { options: n } = t,
          { seg: r } = e,
    ...
    NowIndicatorContainer: (e) =>
      Kt(hr.Consumer, null, (t) => {
        let { options: n } = t,
          r = {
            isAxis: e.isAxis,
    ...
    DayCellContainer: to,
    hasCustomDayCellContent: no,
    EventContainer: Xi,
    renderFill: function (e) {
      return Kt("div", { className: "fc-" + e });
    },
    BgEvent: class extends mr {
      render() {
        let { props: e } = this,
          { seg: t } = e;
        return Kt(Xi, {
    ...
    MoreLinkContainer: class extends mr {
      constructor() {
        super(...arguments),
          (this.state = { isPopoverOpen: !1, popoverId: u() }),
          (this.handleLinkEl = (e) => {
            (this.linkEl = e), this.props.elRef && vr(this.props.elRef, e);
          }),
          (this.handleClick = (e) => {
            ...
            Boolean(e.moreCnt) &&
              Kt(
                mi,
                {
                  ...
                  defaultGenerator: e.defaultGenerator || lo,
      ...
      updateParentEl() {
        this.linkEl && (this.parentEl = n(this.linkEl, ".fc-view-harness"));
      }
    },
    computeEarliestSegStart: uo,
    ViewContainer: class extends mr {
      render() {
        let { props: e, context: t } = this,
          { options: n } = t,
          r = { view: t.viewApi };
        return Kt(
          ...
          Object.assign({}, e, {
            elTag: e.elTag || "div",
            elClasses: [...po(e.viewSpec), ...(e.elClasses || [])],
            renderProps: r,
    ...
    triggerDateSelect: _r,
    getDefaultEventEnd: Dr,
    injectStyles: vo,
    CalendarImpl: Do,
    EventImpl: kr,
    buildEventApis: xr,
  ...
  const wo = [],
    ...
    To = Object.assign(Object.assign({}, So), {
      buttonHints: {
        prev: "Previous $0",
        next: "Next $0",
          ...
          function i(e) {
            for (let s of e) {
              ...
              void 0 === a
                ? ((n[e] = s.id),
                  ...
                  (r = {
                    premiumReleaseDate: Mo(
                      ...
                      o.premiumReleaseDate
                    ),
                    reducers: t.reducers.concat(o.reducers),
                    ...
                    views: Object.assign(Object.assign({}, t.views), o.views),
                    ...
                    namedTimeZonedImpl:
                      o.namedTimeZonedImpl || t.namedTimeZonedImpl,
                    initialView: t.initialView || o.initialView,
                    elementDraggingImpl:
                      t.elementDraggingImpl || o.elementDraggingImpl,
                ...
                : a !== s.id && console.warn(`Duplicate plugin '${e}'`);
            }
            var t, o;
          }
          return e && i(e), i(t), r;
  ...
  function Uo(e, t, n, r) {
    ...
    return H(
      (function (e, t) {
        let n,
          r = {};
        for (n in e) Bo(n, r, e, t);
        for (n in t) Bo(n, r, e, t);
        return r;
      })(i, o),
      (e) =>
        (function (e, t, n, r, i) {
          ...
          return {
            ...
            buttonTextDefault: u(i) || e.defaults.buttonText || u(ke) || e.type,
            buttonTitleOverride: d(r) || d(n) || e.overrides.buttonHint,
            buttonTitleDefault: d(i) || e.defaults.buttonHint || d(ke),
          };
        })(e, o, t, n, r)
    );
  }
  (No.prototype.classes = {
    ...
    (No.prototype.baseIconClass = "fc-icon"),
    (No.prototype.iconClasses = {
      close: "fc-icon-x",
    ...
    (No.prototype.rtlIconClasses = {
      prev: "fc-icon-chevron-right",
      next: "fc-icon-chevron-left",
      prevYear: "fc-icon-chevrons-right",
      nextYear: "fc-icon-chevrons-left",
    }),
    (No.prototype.iconOverrideOption = "buttonIcons"),
    (No.prototype.iconOverrideCustomButtonOption = "icon"),
    (No.prototype.iconOverridePrefix = "fc-icon-");
  let jo = {};
  function zo(e, t, n) {
  ...
  function Fo(e, t, n, r) {
    ...
    switch (t.type) {
      case "ADD_EVENT_SOURCES":
        return Vo(e, t.sources, i, r);
      case "REMOVE_EVENT_SOURCE":
        return (o = e), (s = t.sourceId), B(o, (e) => e.sourceId !== s);
      case "PREV":
      case "NEXT":
      case "CHANGE_DATE":
      case "CHANGE_VIEW_TYPE":
      ...
      case "FETCH_EVENT_SOURCES":
        return Qo(
          e,
          t.sourceIds ? P(t.sourceIds) : Zo(e, r),
          i,
          t.isRefetch || !1,
          r
        );
  ...
  function Vo(e, t, n, r) {
    ...
    return n && (i = Wo(i, n, r)), Object.assign(Object.assign({}, e), i);
  }
  function Wo(e, t, n) {
    return Qo(
      e,
      B(e, (e) =>
        (function (e, t, n) {
          if (!Yo(e, n)) return !e.latestFetchId;
          return (
  ...
  function Go(e, t, n, r) {
    ...
    return (
      s.fetch(
        ...
        (n) => {
          let s = !1;
          i.eventSourceFailure && (i.eventSourceFailure.call(o, n), (s = !0)),
  ...
  function Ko(e, t, n, r, i) {
    return {
      header: e.headerToolbar ? es(e.headerToolbar, e, t, n, r, i) : null,
      footer: e.footerToolbar ? es(e.footerToolbar, e, t, n, r, i) : null,
    };
  }
  function es(e, t, n, r, i, o) {
    let s = {},
      ...
      l = !1;
    for (let c in e) {
      let u = ts(e[c], t, n, r, i, o);
      (s[c] = u.widgets), a.push(...u.viewsWithButtons), (l = l || u.hasTitle);
    }
        ...
        e.split(",").map((e) => {
          ...
          if ((n = a[e]))
            ...
            h.push(e),
              ...
              (v = f.buttonTextOverride) ||
                (m = r.getIconClass(e, s)) ||
                (v = f.buttonTextDefault);
            let n = f.buttonTextOverride || f.buttonTextDefault;
            b = D(
              f.buttonTitleOverride || f.buttonTitleDefault || t.viewHint,
              [n, e],
              n
            );
          } else if (o[e])
            if (
              ...
              (v = l[e]) || (m = r.getIconClass(e, s)) || (v = c[e]),
              "prevYear" === e || "nextYear" === e)
            ) {
              let t = "prevYear" === e ? "prev" : "next";
              b = D(u[t] || d[t], [c.year || "year", "year"], c[e]);
            } else b = (t) => D(u[e] || d[e], [c[t] || t, t], c[e]);
          return {
            buttonName: e,
            buttonClick: g,
            buttonIcon: m,
  ...
  function rs(e, t) {
    let n = U(t.getCurrentData().eventSources);
    if (
      1 === n.length &&
      1 === e.length &&
  ...
  const is = [
      ...
      eventSourceDefs: [
        {
          ...
          fetch(e, t, n) {
            ...
            Ht(
              e.eventSource.meta.bind(null, Qr(e.range, r)),
              (e) => t({ rawEvents: e }),
              n
            );
          },
          ...
          fetch(e, t, n) {
            const { meta: r } = e.eventSource,
              i = (function (e, t, n) {
                ...
                (o = e.timeZoneParam), null == o && (o = l.timeZoneParam);
                s =
      ...
      recurringTypes: [
        {
          ...
          expand(e, t, n) {
            let r = bt(t, { start: e.startRecur, end: e.endRecur });
            return r
              ? (function (e, t, n, r) {
                  let i = e ? P(e) : null,
                    o = K(n.start),
    ...
    Oo({
      name: "misc",
      isLoadingFuncs: [(e) => Lo(e.eventSources)],
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            Object.assign(Object.assign({}, Qr(e.activeRange, t.dateEnv)), {
              view: t.viewApi,
            })
          );
        },
        eventStore: function (e, t) {
          let { emitter: n } = t;
          n.hasHandlers("eventsSet") && n.trigger("eventsSet", xr(e, t));
        },
      },
    }),
  ];
  class os {
    constructor(e, t) {
      (this.runTaskOption = e),
        ...
        (this.queue = []),
        (this.delayedRunner = new Pi(this.drain.bind(this)));
    }
    request(e, t) {
        ...
        Se(
          t.titleFormat ||
            (function (e) {
              ...
              let n = X(e.currentRange.start, e.currentRange.end);
              if (null !== n && n > 1)
  ...
  class as {
    constructor(e) {
      (this.computeCurrentViewData = de(this._computeCurrentViewData)),
        (this.organizeRawLocales = de(ko)),
        (this.buildLocale = de(Ro)),
        (this.buildPluginHooks = Io()),
        (this.buildDateEnv = de(ls)),
        (this.buildTheme = de(cs)),
        (this.parseToolbars = de(Ko)),
        (this.buildViewSpecs = de(Uo)),
        (this.buildDateProfileGenerator = fe(us)),
        (this.buildViewApi = de(ds)),
        (this.buildViewUiProps = fe(ps)),
        (this.buildEventUiBySource = de(fs, j)),
        (this.buildEventUiBases = de(hs)),
        (this.parseContextBusinessHours = fe(ms)),
        (this.buildTitle = de(ss)),
        (this.emitter = new Pt()),
        (this.actionRunner = new os(
      ...
      let o = (function (e, t) {
          let n = e.initialDate;
          return null != n ? t.createMarker(n) : Ar(e.now, t);
        })(n.calendarOptions, n.dateEnv),
        s = i.dateProfileGenerator.build(o);
      Et(s.activeRange, o) || (o = s.currentRange.start);
      let a = {
        dateEnv: n.dateEnv,
      ...
      let l = zo(n.calendarOptions, s, a),
        c = {
      ...
      for (let e of n.pluginHooks.reducers) Object.assign(c, e(null, null, u));
      gs(c, a) && this.emitter.trigger("loading", !0),
        (this.state = c),
        this.updateData(),
    ...
    _handleAction(e) {
      ...
      this.data &&
        ...
        ("PREV" !== e.type && "NEXT" !== e.type && Et(u.currentRange, c)) ||
          (c = u.currentRange.start);
      let d = Fo(n.eventSources, e, u, l),
        f = wi(n.eventStore, e, d, u, l),
        h =
          (Lo(d) &&
        ...
        v = {
          ...
          selectionConfig: g,
          eventUiBases: this.buildEventUiBases(h.defs, p, m),
      ...
      for (let t of o.pluginHooks.reducers) Object.assign(v, t(n, e, b));
      let A = gs(n, l),
        y = gs(v, l);
      !A && y ? r.trigger("loading", !0) : A && !y && r.trigger("loading", !1),
        (this.state = v),
      ...
      if (a && a !== l) {
        a.timeZone !== l.timeZone &&
          ...
          (t.eventStore = o.eventStore =
            ...
            })(o.eventStore, n.dateEnv, o.dateEnv)));
        for (let e in s)
    ...
    processRawCalendarOptions(e, t) {
      let { locales: n, locale: r } = Be([ke, e, t]),
        ...
        l = (this.currentCalendarOptionsRefiners = Object.assign(
          Object.assign(
            Object.assign(Object.assign(Object.assign({}, Te), Re), xe),
            a.listenerRefiners
          ),
          a.optionRefiners
        )),
      ...
      for (let e in u)
        ...
        (u[e] === f[e] || (Oe[e] && e in f && Oe[e](f[e], u[e])))
          ? (d[e] = h[e])
          : l[e]
          ? ((d[e] = l[e](u[e])), (p = !0))
          : (c[e] = f[e]);
    ...
    processRawViewOptions(e, t, n, r, i) {
      let o = Be([ke, e.optionDefaults, n, r, e.optionOverrides, i]),
        s = Object.assign(
          Object.assign(
            Object.assign(
              Object.assign(Object.assign(Object.assign({}, Te), Re), xe),
        ...
        d = {};
      for (let e in o)
        o[e] === l[e] || (Oe[e] && Oe[e](o[e], l[e]))
          ? (a[e] = c[e])
          : (o[e] === this.currentCalendarOptionsInput[e] ||
            (Oe[e] && Oe[e](o[e], this.currentCalendarOptionsInput[e]))
  ...
  function ls(e, t, n, r, i, o, s, a) {
    let l = Ro(t || s.defaultCode, s.map);
    return new Xr({
  ...
  function cs(e, t) {
    return new (t.themeClasses[e.themeSystem] || No)(e);
  }
  function us(e) {
    return new (e.dateProfileGeneratorClass || yr)(e);
  }
  function ds(e, t, n) {
    return new ns(e, t, n);
  }
  ...
  function ms(e) {
    return at(e.options.businessHours, e);
  }
  function vs(e, t) {
    for (let n in e)
  ...
  class ys extends mr {
    constructor() {
      super(...arguments),
        ...
        (this.handleEl = (e) => {
          (this.el = e), vr(this.props.elRef, e), this.updateAvailableWidth();
        }),
        (this.handleResize = () => {
      ...
      super(e),
        (this.handleSegClick = (e, t) => {
          let { component: r } = this,
            { context: i } = r,
            o = Mr(t);
          if (o && r.isValidSegDownEl(e.target)) {
            let s = n(e.target, ".fc-event-forced-url"),
              a = s ? s.querySelector("a[href]").href : "";
            i.emitter.trigger("eventClick", {
              el: t,
              event: new kr(r.context, o.eventRange.def, o.eventRange.instance),
              jsEvent: e,
              view: i.viewApi,
            }),
        ...
        (this.destroy = f(e.el, "click", ".fc-event", this.handleSegClick));
    }
  }
  class Es extends ii {
    constructor(e) {
    ...
    triggerEvent(e, t, n) {
      ...
      (t && !r.isValidSegDownEl(t.target)) ||
        i.emitter.trigger(e, {
          el: n,
          event: new kr(i, o.eventRange.def, o.eventRange.instance),
          jsEvent: t,
          view: i.viewApi,
        });
    }
  ...
  class Ds extends gr {
    constructor() {
      super(...arguments),
        (this.buildViewContext = de(pr)),
        (this.buildViewPropTransformers = de(ws)),
        (this.buildToolbarProps = de(Cs)),
        (this.headerRef = { current: null }),
        (this.footerRef = { current: null }),
        (this.interactionsStore = {}),
        (this.state = { viewLabelId: u() }),
    ...
    buildAppendContent() {
      let { props: e } = this;
      return Kt(nn, {}, ...e.pluginHooks.viewContainerAppends.map((t) => t(e)));
    }
    renderView(e) {
      let { pluginHooks: t } = e,
        { viewSpec: n } = e,
      ...
      return Kt(n.component, Object.assign({}, r));
    }
  }
  function Cs(e, t, n, r, i, o) {
    ...
    return {
      ...
      isTodayEnabled: s.isValid && !Et(t.currentRange, i),
  ...
  function Ss(e) {
    let t = Ro(e.locale || "en", ko([]).map);
    return new Xr(
      Object.assign(
        Object.assign({ timeZone: ke.timeZone, calendarSystem: "gregory" }, e),
        { locale: t }
      )
    );
  }
  return (
    (e.Calendar = class extends Do {
      constructor(e, t = {}) {
        super(),
          (this.isRendering = !1),
          (this.isRendered = !1),
          ...
          (function (e) {
            ...
            if (!mo.get(t)) {
              mo.set(t, !0);
              for (const e of go) bo(t, e.innerText);
            }
          })(e),
          (this.el = e),
          (this.renderRunner = new Pi(this.handleRenderRequest)),
          new as({
            optionOverrides: t,
            calendarApi: this,
    ...
    (e.formatRange = function (e, t, n) {
      ...
      return o && s
        ? r.formatRange(o.marker, s.marker, i, {
            ...
            defaultSeparator: ke.defaultRangeSeparator,
          })
        : "";
    }),
    (e.globalLocales = wo),
