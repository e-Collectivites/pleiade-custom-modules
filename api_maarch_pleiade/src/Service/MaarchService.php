...
class MaarchService implements MaarchServiceInterface
{
  ...
  public function __construct(AccountProxyInterface $current_user)
  {
    ...
    $this->key = $array[$collectivite]['token_maarch'];
    $this->url =  $array[$collectivite]['url_maarch'] .  $config->get('route');
    $this->redirectUrl = $array[$collectivite]['url_maarch'] . "/dist/index.html#";
    $stingBaskets = $array[$collectivite]['baskets_maarch'];
  ...
  public function getUserId(): ?int
  {
    ...
    if (empty($fieldValue)) {
      ...
      $maarchUserId = $this->getMaarchUserId($userMail);
