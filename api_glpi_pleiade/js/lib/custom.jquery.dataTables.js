...
(function (h) {
  ...
  function qb(a) {
    var b = a.oClasses,
      ...
      e = a.oPreviousSearch,
      f = a.aanFeatures,
      g = '<input type="search" class="ms-4 ' + b.sFilterInput + '"/>',
      j = d.sSearch,
      j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g,
      b = h("<div/>", {
        id: !f.f ? c + "_filter" : null,
        class: b.sFilter + ' d-flex align-items-center justify-content-end ',
      }).append(h("<label class='d-flex align-items-center justify-content-end'/>").append(j)),
      f = function () {
  ...
  function pb(a) {
    for (
      var b = a.oClasses,
        ...
        f = e ? d[0] : d,
        d = e ? d[1] : d,
        e = h("<select class='form-select form-select-sm mx-2 w-50'/>", {
          name: c + "_length",
          "aria-controls": c,
    ...
    var i = h("<div><label class='d-flex align-items-center'/></div>").addClass(b.sLength);
  ...
  h.extend(n.ext.classes, {
    ...
    sPaging: "dataTables_paginate justify-content-end d-flex paging_",
