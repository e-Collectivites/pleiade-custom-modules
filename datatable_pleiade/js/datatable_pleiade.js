(function (Drupal, $, drupalSettings) {
  ...
  Drupal.behaviors.DatatableDocBehavior = {
                ...
                if (apiResponse && apiResponse.docs && apiResponse.docs.length > 0) {
                    ...
                    for (var i = 0; i < donnees.length; i++) {
                        ...
                        if(dateStr){
                            ...
                            if(parts.length === 3){
                                ...
                                // Set a display-friendly date
                                row.objectDateDisplay = new Date(year, month, day).toLocaleDateString("fr-FR");
                            }
                        } else {
                            row.objectDateDisplay = '';
                        }
                    ...
                    documentsTable = new Tabulator("#tabulator-documents", {
                        ...
                        columns:[
                            ...
                            {title:"Date", field:"objectDateDisplay"},
                    ...
                    // **FIX**: Call the setup functions immediately after table creation to ensure UI elements are always created.
    ...
    // Custom print function that works with filtered data
    function printFilteredTable(table) {
        ...
        const filteredData = table.getData("active"); // Use "active" for filtered data in old versions
    ...
    function setupActionButtons(table) {
        ...
        // **FIX**: Use the custom print function
        ...
        // **FIX**: Populate the columns menu inside a short timeout.
        // This gives the old Tabulator version time to render the columns before we access them.
        setTimeout(function() {
